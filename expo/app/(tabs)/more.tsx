  ...
  const menuSections: MenuSection[] = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'Low stock and restock suggestions',
          icon: Package,
          route: '/reorder-suggestions',
          color: '#10B981',
          gradient: ['#10B981', '#059669'],
          visible: isFeatureVisible('reorder-suggestions'),
          disabled: isEmployee && !hasPermission(['products:view', 'products:manage_stock']),
        },
        {
          id: 'customers',
          title: 'Customers',
      ...
      items: [
        {
          ...
          description: 'Search & discover new suppliers',
          icon: Search,
          route: '/suppliers-marketplace',
          color: '#0EA5E9',
          gradient: ['#0EA5E9', '#0284C7'],
          visible: isFeatureVisible('supplier-marketplace'),
          disabled: isEmployee && !hasPermission(['suppliers:view_marketplace']),
        },
        {
          id: 'my-suppliers',
          title: 'My Suppliers',
          description: 'Your private supplier contacts',
          icon: Truck,
          route: '/(tabs)/suppliers',
          color: '#8B5CF6',
          gradient: ['#8B5CF6', '#7C3AED'],
          visible: isFeatureVisible('supplier-section') || isFeatureVisible('suppliers'),
          disabled: isEmployee,
        },
        {
          id: 'my-application',
          title: 'My Application',
          description: 'View your supplier application status',
          icon: FileText,
          route: '/suppliers-marketplace/my-application',
          color: '#0EA5E9',
          gradient: ['#0EA5E9', '#0284C7'],
          visible: !isEmployee && isFeatureVisible('supplier-marketplace'),
        },
        {
          id: 'become-a-supplier',
          title: 'Become a Supplier',
          description: 'Apply to sell on the marketplace',
          icon: UserPlus,
          route: '/suppliers-marketplace/become-a-supplier',
          color: '#10B981',
          gradient: ['#10B981', '#059669'],
          visible: !isEmployee && isFeatureVisible('supplier-marketplace'),
        },
        {
          ...
          description: 'Stores of your saved suppliers',
          icon: Store,
          route: '/suppliers-marketplace/my-stores',
          color: '#F59E0B',
          gradient: ['#F59E0B', '#D97706'],
          visible: isFeatureVisible('supplier-marketplace'),
          disabled: isEmployee && !hasPermission(['suppliers:view_marketplace']),
        },
        {
          ...
          description: 'Manage your supplier store & products',
          icon: Layers,
          route: '/supplier',
          color: '#6366F1',
          gradient: ['#6366F1', '#4F46E5'],
          visible: !isEmployee && isFeatureVisible('supplier-sell'),
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          id: 'store-cart',
          title: 'Cart & Checkout',
          description: 'View cart and pay for DreamBig store items',
          icon: ShoppingCart,
          route: '/(tabs)/store/cart',
          color: '#6366F1',
        ...
        },
        {
          id: 'my-purchases',
          title: 'My Purchases',
          description: 'Store orders & digital access',
          icon: Package,
          route: '/my-purchases',
          color: '#8B5CF6',
          gradient: ['#8B5CF6', '#7C3AED'],
